                    ...
                    <form action="{{ route('user.store') }}" method="POST">
                        ...
                        <div class="row mb-4">
                            ...
                            <div class="col-lg-4 col-sm-12">
                                ...
                                <div class="mb-3">
                                    <label for="confirmation_passoword" class="form-label">Password Confirmation</label>
                                    <input type="password" name="password_confirmation" id="passowrd" class="form-control">
                                </div>
